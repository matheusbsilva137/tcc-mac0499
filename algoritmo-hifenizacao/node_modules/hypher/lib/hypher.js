const {BloomFilter, CuckooFilter} = require('bloom-filters')

/**
 * @constructor
 * @param {!{patterns: !Object, leftmin: !number, rightmin: !number}} language The language pattern file. Compatible with Hyphenator.js.
 */
function Hypher(language, epsilon, filter) {
    var exceptions = [],
        i = 0;
    /**
    ...
    if (language['exceptions']) {
        ...
        this.exceptionsFilter = filter === 'cuckoo-filter' ? CuckooFilter.from(exceptions, epsilon) : BloomFilter.from(exceptions, epsilon);
    }
}
...
Hypher.prototype.hyphenate = function (word) {
    ...
    if (this.exceptionsFilter.has(lowerCaseWord) && this.exceptions.hasOwnProperty(lowerCaseWord)) {
